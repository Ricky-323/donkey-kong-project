...
namespace DonkeyKongGame
{
    ...
    {
        List<Monster2> _monsters = new List<Monster2>();
        ...
        private void PlayMusic()
        {
            ...
            string musicPath = Path.Combine(baseDir, "assets", "map2Audio.mp3");

            StopMusic();

            string commandOpen = $"open \"{musicPath}\" type mpegvideo alias Map2Music";
            mciSendString(commandOpen, null, 0, IntPtr.Zero);

            string commandPlay = "play Map2Music repeat";
            mciSendString(commandPlay, null, 0, IntPtr.Zero);
        }

        private void StopMusic()
        {
            mciSendString("close Map2Music", null, 0, IntPtr.Zero);
        }
        ...
        public map2()
        {
            ...
            _monsters.Add(new Monster2(1400, 290 - 52, 1300, 1600));
            _monsters.Add(new Monster2(1200, 1008 - 52, 300, 1700));

            // Monster 3: Middle Platform Left (Floor Y is 720)
            _monsters.Add(new Monster2(300, 817 - 52, 100, 430));
            _monsters.Add(new Monster2(400, 240 - 52, 100, 430));

            // Monster 4: Middle Platform Right (Floor Y is 672)
            _monsters.Add(new Monster2(900, 820 - 52, 900, 1400));

            // Monster 5: High Platform (Floor Y is 480)
            _monsters.Add(new Monster2(1300, 625 - 52, 1200, 1600));
            // 2. ENABLE SCROLLING
            // Since 1920x1056 is larger than many screens, we allow scrolˇling.
            ...
            // 3. Initialize Map
            mapManager.InitializeMap(LevelId.Map2);
