...
namespace DonkeyKongGame
{
    public class Monster2
    {
        ...
        public Monster2(float startX, float startY, float minX, float maxX)
        {
            X = startX;
            Y = startY;
            _minX = minX;
        ...
        private void LoadImages()
        {
            ...
            for (int i = 0; i < 8; i++)
            {
                string path = Path.Combine(monsterDir, $"Snake{i + 1}.png");
            ...
            for (int i = 0; i < 10; i++)
            {
                string path = Path.Combine(monsterDir, $"SnakeAttack{i + 1}.png");
